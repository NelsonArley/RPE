...
<div class="container">
            ...
            <span class="d-block mt-5 p-2  text-dark text-center" style="background-color:#c7adf0 ;" ><h2><b><i> <font style="color:#2e0f5e;">Registro Venta de Producto </font></i></b></h2></span>
                ...
                <form id="venta" name="venta" method="POST" action="../controller/ventaBodegueroC.php">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <label class="form-label" value="<?php echo $ide ?>" for="form7Example2"> Numero de la factura de la venta   </label>

                    </div>
                    <button id="registro" name="enviar" type="submit" class="btn btn-secondary btn-rounded">Registrar</button>
                </form>
            </div>
    ...
    <tbody>
            ...
            foreach ($datos as $key) 
            {
                ...
                <tr>
                    ...
                    <td><a href="FeditarVentaBod.php?id=<?php echo $key['id_venta']?>" class="btn btn-warning">Actualizar</a></td>
                    <td><a href="../controller/EliminarVentaBod.php?id=<?php echo $key['id_venta']?>" class="btn btn-warning">Eliminar</a></td>
